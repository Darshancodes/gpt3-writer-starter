...
const Home = () => {
  ...
  return (
    <div className="root">
      <Head>
        <title>GPT3 Project Ideas Generator</title>
      </Head>
      <div className="container">
        <div className="header">
          ...
          <div className='header-title-1'>
            <h2>Built with GPT-3</h2>
          </div>
          <div className="header-subtitle">
            <h2>Confused in which project to make? Give me a prompt and I got your back</h2>
          </div>
        </div>
